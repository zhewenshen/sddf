...
// OUTCOME: Deadlock - COPY interrupted by client before setting CLT_RX_free notify flag to 1, CLT runs and does not notify COPY upon completion. 
...
init priority 2 {
    ...
    // Setting this to emulate that the MUX_RX is setting it's flag when required
...
active proctype COPY() priority 1 {
    do
        ...
        :: CLT_RX_free.notification ? 1 ->
            ...
            if 
                :: CLT_RX_used.notify_flag && enqueued && !(CLT_RX_used.notification ?? [1]) -> CLT_RX_used.notification ! 1;
                :: else;
            fi;

            if 
                :: CPY_RX_free.notify_flag && enqueued && !(CPY_RX_free.notification ?? [1]) -> CPY_RX_free.notification ! 1;
                :: else;
            fi;
    od;
}
    ...
    do
        ...
        :: CPY_RX_free.notification ? 1 ->
            ...
            if
                ...
                :: notify_client && CPY_RX_used.notify_flag && !(CPY_RX_used.notification ?? [1]) -> CPY_RX_used.notification ! 1;
                :: else;
            fi
