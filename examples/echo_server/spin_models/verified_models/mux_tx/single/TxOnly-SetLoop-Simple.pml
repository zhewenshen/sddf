...
// OPTIMISATIONS: CLT only sets flag if free ring is empty, ETH transfers packets from used to free
...
// - HW_LENGTH = 3 = 0.31, 652
// - HW_LENGTH = 5 = 1.84, 1796
// One Client, one ARP (priorities: clients = 1, mux = 2, eth = 3)
// - HW_LENGTH = 3 = 0.90, 453
// - HW_LENGTH = 5 = 0.38, 1063
// One Client, one ARP (priorities: clients = 1, mux = 1, eth = 3)
// - HW_LENGTH = 3 = 16.3, 346
// - HW_LENGTH = 5 = 0.38, 1063
// Three Clients (priorities: clients = 1, mux = 2, eth = 3)
// - HW_LENGTH = 3 = 5.11, 591
// - HW_LENGTH = 5 = 31.5, 1063
...
active proctype ETH() priority 1 {
    do
        ...
        :: ETH_TX_used.notification ? 1 ->
            ...
            do
                :: !EMPTY(ETH_TX_used)->
                    TRANSFER_PACKET(ETH_TX_used, HW_LENGTH, ETH_TX_free, HW_LENGTH, ETH_TX_used.ring[ETH_TX_used.tail]);
