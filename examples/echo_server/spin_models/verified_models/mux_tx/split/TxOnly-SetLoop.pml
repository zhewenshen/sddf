...
// - CLIENT = 96.8, 12508151
// - ARP = 1.39, 229
// Two Clients (priorities: clients = 1, mux = 2, eth = 3)
// - HW_LENGTH = 3 = 1.09, 781
// - HW_LENGTH = 5 = 12.04, 2234
// One Client, one ARP (priorities: clients = 1, mux = 2, eth = 3)
// - HW_LENGTH = 3 = 0.11, 662
// - HW_LENGTH = 5 = 0.52, 1328
...
active proctype ETH() priority 1 {
    do
        ...
        :: ETH_STORED_PACKETS > 0 ->
            bit hw_was_full = (ETH_STORED_PACKETS == (HW_LENGTH - 1));
            ...
            if  
                // Notify ETH2 that there are now free spaces in the HW_TX queue to send packets
...
active proctype ETH2() priority 1 {
    do
