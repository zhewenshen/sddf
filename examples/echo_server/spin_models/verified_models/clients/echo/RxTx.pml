...
// SIMPLIFICATIONS:
// OUTCOME: System actually verifies as is without deadlock - this is assumin the MUX_TX is setting it's
// notify flag appropriately - similarly with the COPY.
// TODO: Clarify with Lucy exactly where lwip eth send is actually called so I know when flags are getting set
